...
<template>
  <div
    class="fixed flex w-screen h-screen justify-center items-center flex-col z-[99] overflow-hidden bg-white dark:bg-neutral-950"
  >
    <!-- <div
    ...
    <svg
      ...
      class="rounded-md border border-[#d8dcdf] transition-colors dark:border-[#323232]"
    >
      <rect width="200" height="200" fill="black" />
      <path d="M114.925 44H77C71.4772 44 67 48.4772 67 54V110.945C67 120.841 79.8373 124.725 85.3231 116.488L123.248 59.5431C127.674 52.8973 122.91 44 114.925 44Z" fill="white" />
      <path d="M134 162.3C137.314 162.3 140.062 159.584 139.356 156.346C137.911 149.727 134.078 143.577 128.284 138.753C120.783 132.508 110.609 129 100 129C89.3913 129 79.2172 132.508 71.7157 138.753C65.9221 143.577 62.0893 149.727 60.6444 156.346C59.9377 159.584 62.6863 162.3 66 162.3L100 162.3H134Z" fill="white" />
    </svg>
  </div>
</template>
